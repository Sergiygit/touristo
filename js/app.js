(() => {
    ...
    function initSliders() {
        ...
        if (document.querySelector(".swiper-offers")) new core(".swiper-offers", {
            modules: [ Navigation, Pagination ],
            observer: true,
            observeParents: true,
            spaceBetween: 32,
        ...
        if (document.querySelector(".swiper-rewiev")) new core(".swiper-rewiev", {
            modules: [ Navigation, Pagination ],
            observer: true,
            observeParents: true,
            spaceBetween: 32,
        ...
        t(document).on("mouseup", (function() {
            ...
            _mouseCapture: function(e) {
                ...
                this.handles.each((function(e) {
                    ...
                    o = t(this), a = e);
                })), r = this._start(e, a), !1 === r ? !1 : (this._mouseSliding = !0, this._handleIndex = a, 
            ...
            _slide: function(t, e, i) {
                ...
                a[e] = i), i !== o && (s = this._trigger("slide", t, this._uiHash(e, i, a)), !1 !== s && (this._hasMultipleValues() ? this.values(e, i) : this.value(i)));
            },
            _stop: function(t, e) {
            ...
            _refreshValue: function() {
                ...
                this._hasMultipleValues() ? this.handles.each((function(s) {
                    ...
                    t(this).stop(1, 1)[h ? "animate" : "css"](c, r.animate), !0 === l.options.range && ("horizontal" === l.orientation ? (0 === s && l.range.stop(1, 1)[h ? "animate" : "css"]({
                        left: i + "%"
    ...
    $(".polzunok-container-5 input").change((function() {
        var input_left = $(".polzunok-input-5-left").val().replace(/[^0-9]/g, ""), opt_left = $(".polzunok-5").slider("option", "min"), where_right = $(".polzunok-5").slider("values", 1), input_right = $(".polzunok-input-5-right").val().replace(/[^0-9]/g, ""), opt_right = $(".polzunok-5").slider("option", "max"), where_left = $(".polzunok-5").slider("values", 0);
